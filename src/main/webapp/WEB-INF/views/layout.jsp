...
<body>
	...
	<div class="sidebar">
		...
		<ul id="silde-nav-menu-base-info" class="nav nav-list bs-docs-sidenav silde-show-or-hide">
       		<li class="slide-nav-menu active"><a href="#"><i class="icon-home"></i><i class="icon-chevron-right"></i>欢迎页</a></li>
      		<li class="slide-nav-menu"><a href="#"><i class="icon-reorder"></i><i class="icon-chevron-right"></i>区域 </a></li>
       		<li class="slide-nav-menu"><a href="#"><i class="icon-sitemap"></i><i class="icon-chevron-right"></i>学校</a></li>
